...
class Lab5Frame(ctk.CTkFrame):
    def __init__(self, master, sig_service, on_back):
        ...
        self.status_label = ctk.CTkLabel(self, text="Status: Ready", text_color="#00FF41")
    ...
    def sign_text(self):
        ...
        if key_path:
            ...
            self.status_label.configure(text="Status: String Signed", text_color="#E0AAFF")
    ...
    def sign_file(self):
        ...
        self.sig_output.delete("1.0", "end")
        self.sig_output.insert("1.0", hex_sig)
        self.status_label.configure(text="Status: File Signed", text_color="#E0AAFF")
    ...
    def verify_file(self):
        ...
        if is_valid:
            self.status_label.configure(text="Status: Signature VALID", text_color="#00FF41")
            messagebox.showinfo("Result", "✅ ПІДПИС ВІРНИЙ")
        else:
            self.status_label.configure(text="Status: Signature INVALID", text_color="#FF4B2B")
